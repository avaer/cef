...
CefMenuRunnerAndroid::CefMenuRunnerAndroid() {}

bool CefMenuRunnerAndroid::RunContextMenu(
...
void CefMenuRunnerAndroid::CancelContextMenu() {
  /* if (menu_)
    menu_->Cancel(); */
}

bool CefMenuRunnerAndroid::FormatLabel(base::string16& label) {
